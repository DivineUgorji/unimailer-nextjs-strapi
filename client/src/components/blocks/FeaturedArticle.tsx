...
//     >
//       {/* ── Background: ambient orange orb ── */}
//       {/* <motion.div
//         className="absolute -top-32 -right-32 w-[480px] h-[480px] rounded-full
//                    bg-orange-500/10 blur-[96px] pointer-events-none"
...
//              bg-orange-500/10 blur-[96px] pointer-events-none -z-10"
//         initial={{ opacity: 0, scale: 0.8 }}
//         animate={{ opacity: 1, scale: 1 }}
//         transition={{ duration: 1.4, ease: "easeOut" }}
//       /> */}
...
//       {/* ── Background: small secondary orb bottom-left ── */}
//       {/* <motion.div
//         className="absolute -bottom-20 -left-20 w-64 h-64 rounded-full
//                    bg-orange-400/8 blur-[72px] pointer-events-none"
//         initial={{ opacity: 0 }}
//         animate={{ opacity: 1 }}
...
//              bg-orange-400/8 blur-[72px] pointer-events-none -z-10"
//         initial={{ opacity: 0 }}
//         animate={{ opacity: 1 }}
//         transition={{ duration: 1.6, delay: 0.3, ease: "easeOut" }}
//       />
...
//                    font-serif text-[clamp(4rem,12vw,10rem)] font-bold leading-none
//                    text-black/[0.03] whitespace-nowrap overflow-hidden"
//       >
//         Featured
//       </div>
...
//           <motion.div
//             className="hidden sm:flex items-center gap-1.5 border border-current/15
...
//         {/* ── Divider ── */}
//         <motion.div
//           className="w-full h-px bg-current/10 mb-12 origin-left"
//           initial={{ scaleX: 0 }}
//           animate={{ scaleX: 1 }}
...
//             {/* Excerpt */}
//             <motion.p
//               className="text-base leading-[1.8] opacity-60 max-w-[44ch] m-0"
//               variants={fadeUp}
//               transition={{ duration: 0.65, ease: [0.22, 1, 0.36, 1] }}
//             >
//               {excerpt}
...
//                            border-b border-current/30 w-fit transition-all duration-250
...
//             <motion.div
//               className="hidden md:flex items-center gap-1.5 mt-4"
//               variants={fadeUp}
...
//             {/* Second, fainter offset layer for depth */}
//             <div
        ...
        >
          <span
            ...
            className="select-none font-serif text-[clamp(4rem,12vw,9rem)] font-bold
                       leading-none text-black/[0.045] pointer-events-none"
          >
            Our Blog
          </span>
        </motion.div>
