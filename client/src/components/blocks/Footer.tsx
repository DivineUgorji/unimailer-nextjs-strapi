...
//         <div className=" border-t border-neutral-400/15 pt-12 text-center text-sm opacity-70"></div>
//         {/* Top Footer */}
...
//             <p className="text-neutral-300/80 text-sm max-w-sm">
//               {description}
//             </p>
...
//         {/* Divider */}
//         <div className="mt-12 border-t border-neutral-400/15 pt-6 text-center text-sm opacity-70">
...
//           {/* Brand column */}
//           <div className="space-y-6 max-w-sm lg:max-w-md">
//             <StrapiImage
//               src={footerLogo.image.url}
//               height={33}
//               width={150}
...
//             {footerColumns.map((column) => (
//               <div key={column.id} className="space-y-4 min-w-35">
//                 <h6 className="text-neutral-400/90">{column.title}</h6>
...
export function Footer({
  ...
  const item: Variants = {
    ...
    visible: {
      ...
      transition: {
        duration: 0.45,
        ease: [0.16, 1, 0.3, 1], // modern smooth easing
      },
    },
  };
